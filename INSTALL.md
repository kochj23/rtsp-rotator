...
```bash
# Export preferences
defaults export com.kochj23.app ~/rtsp-rotator-backup.plist

# Import preferences (on another Mac or after reinstall)
defaults import com.kochj23.app ~/rtsp-rotator-backup.plist
```
...
rm -rf ~/Library/Caches/com.kochj23.app
